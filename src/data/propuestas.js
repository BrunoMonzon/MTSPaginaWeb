export const propuestas = [
  {
    ...
    componente: 'Fortalecer aspectos técnicos y tecnológicos para maximizar la producción agropecuaria, conformación de asociaciones productivas priorizando a grupos de mujeres. Fortalecer la cadena productiva focalizando el potencial productivo de cada región, acomplando a las industrias y plantas de transformación implementadas en el departamento. Agricultura sostenible amigable con el medio ambiente.',
    detalles: [
      'Construcción de Presas y Represas en todo el departamento Chuquisaca',
  ...
  },
  {
    ...
    detalles: [
      ...
      'Tratamiento y valorización de residuos sólidos mediante la implementación de reciclaje industrial',
      'Forestación con plantas nativas a las cabeceras de ríos y ojos de agua',
      'Perforación de pozos para agua potable'
    ]
  },
  {
    ...
    detalles: [
      'Gestión de recursos carreteras: Sucre-Poroma-Toro Toro, Conclusión Salto-Monteagudo, Transversal Juana Azurduy de Padilla, Ruta Héroes del Chaco, Ruta Kochas-San Lucas-Padcoyo, Doble Vía Sucre-Potosí, Doble Vía Sucre-Aiquile, Gran Circunvalación Ciudad de Sucre',
      'Equipar el SEDCAM (revolución caminera)',
      'Construcción de los caminos: Sucre-Maragua, Sucre-Chamina-Tres Cruces, Puente Charal, Camino Quepupanapa-Mojocoya-Puente Inca, Zudañez-La Torre, Konchu Pata-Alcala-El Villar, Muyupampa-Las Frías'
    ]
  },
  {
    id: 'energia',
    ...
    detalles: [
      ...
      'Redición de costo energético para productores y apoyo a industrialización local',
  ...
  },
  {
    ...
    componente: 'Turismo con enfoque Regional e Integración del Sur (Chuquisaca, Potosí y Tarija). Cadenas Turísticas con el sistema nacional e internacional. Promoción de los 12 destinos turísticos de Chuquisaca.',
    detalles: [
      'Feria artesanal y cultural permanente (Centro Matilde Casasola y centro artesanal) en la Gobernación-municipios. Sector privado',
  ...
  },
  {
    ...
    componente: 'Fortalecer las redes de Salud en el departamento con la modernización y equipamiento de centros de salud en zonas urbanas y rurales. Fortalecer el SUS para la atención integral con tecnología médica moderna y la implementación sistematizada de archivos.',
    detalles: [
      'Consolidación de los hospitales de 2do Nivel del Chaco y Cintis, además priorizar construcción del hospital de 2do. Nivel en Chuquisaca Centro',
      'Gestión para consolidar la ciudadela medica en la ciudad de Sucre',
      'Ítems y equipamiento en relación distribución política en salud',
      'Digitalización de registros médicos y control de estadísticas de salud, reduciendo los tiempos de espera, apps de salud para citas médicas, control de vacunación y recordatorios de medicación'
    ]
  },
  {
    id: 'educacion',
    ...
    componente: 'Fortalecer la formación técnica y en oficios en los ámbitos agropecuario, turístico y tecnológico, mediante talleres prácticos vinculados a empresas y emprendimientos, así como convenios con sectores productivos para prácticas y pasantías.',
    detalles: [
      'Fortalecer los institutos tecnológicos, articulando la educación técnica con programas de innovación y proyectos de desarrollo local',
      'Implementar bibliotecas virtuales en los municipios, facilitando la conectividad a internet y el acceso a recursos educativos digitales'
    ]
  },
  {
    id: 'deporte',
    ...
    detalles: [
      ...
      'Aperturar campos deportivos en horarios específicos para la practica libre del deporte'
    ]
  },
  {
    id: 'austeridad',
    ...
    detalles: [
      'Ajustar el organigrama institucional e acuerdo al plan programático de la institución',
      'Establecer como salario máximo 12,000Bs. en base la cual se debe general una nueva escala salarial por el 2026'
    ]
  },
  {
    id: 'reactivacion',
